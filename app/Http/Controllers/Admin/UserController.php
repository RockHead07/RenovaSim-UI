...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // Check unique email and username via Supabase
    ...
    public function edit(int $user)
    {
        ...
        $selectedProjectIds = []; // project-user pivot would need a separate table
        $timezones = \DateTimeZone::listIdentifiers();
        $languages = ['en' => 'English', 'es' => 'Spanish', 'fr' => 'French', 'de' => 'German', 'pt' => 'Portuguese'];

        return view('admin.users.edit', ['user' => $userObj, 'projects' => $projects, 'selectedProjectIds' => $selectedProjectIds, 'timezones' => $timezones, 'languages' => $languages]);
    }
