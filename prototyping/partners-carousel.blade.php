...
<section class="py-16" style="background-color: #2C2C2B; border-bottom: 1px solid rgba(245, 245, 245, 0.1);">
    ...
    <div class="relative overflow-hidden">
        {{-- Fade edges --}}
        <div class="absolute left-0 top-0 bottom-0 w-16 z-10" style="background: linear-gradient(to right, #2C2C2B, transparent);"></div>
        <div class="absolute right-0 top-0 bottom-0 w-16 z-10" style="background: linear-gradient(to left, #2C2C2B, transparent);"></div>
