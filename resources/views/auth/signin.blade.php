                        ...
                        <div>
                            ...
                            <div class="relative" x-data="{ show: false }">
                                <input
                                    ...
                                    name="password"
                                    class="w-full rounded-full border border-signin-border bg-transparent px-5 py-3 text-sm font-sans text-signin-foreground focus:outline-none focus:ring-2 focus:ring-ring pr-12"
                                    required
                                />
                                <button
                                    type="button"
