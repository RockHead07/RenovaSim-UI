                        ...
                        <div>
                            ...
                            <div class="relative" x-data="{ show: false }">
                                <input
                                    ...
                                    name="password"
                                    class="w-full rounded-full border border-signin-border bg-transparent px-4 py-2 text-xs font-sans text-signin-foreground focus:outline-none focus:ring-2 focus:ring-ring pr-10"
                                    required
                                />
                                <button
                                    type="button"
