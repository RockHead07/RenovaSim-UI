@extends('admin.layout')
  ...
  <div class="bg-card rounded-xl w-full max-w-2xl border border-border/10">
    <div class="p-6 pb-0"><h2 class="font-serif text-foreground text-lg">Edit Plan</h2></div>
    <form method="POST" action="/admin/pricing-plans/{{ $plan->id ?? 1 }}" class="p-6 space-y-5">
      @csrf
      @method('PUT')
