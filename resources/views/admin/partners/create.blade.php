@extends('admin.layout')
  ...
  <div class="bg-card rounded-xl w-full max-w-2xl border border-border/10">
    <div class="p-6 pb-0"><h2 class="font-serif text-foreground text-lg">Add Partner</h2></div>
    
    @if ($errors->any())
    <div class="p-4 mx-6 mt-4 bg-red-500/10 border border-red-500/20 rounded-lg">
    ...
    <form method="POST" action="/admin/partners" enctype="multipart/form-data" class="p-6 space-y-5">
      @csrf
